...
enum Game_Button_Index {
    ...
    GAME_BUTTON_INDEX_use      = 14,
    
    GAME_BUTTON_INDEX_editor   = 30,
    GAME_BUTTON_INDEX_profiler = 31,
...
struct Input {
    ...
    u32 old_button_state;
    u32 new_button_state;
};
...
static inline bool button_released(Input *in, s32 button) {
...
static inline bool button_held(Input *in, s32 button) {
...
static inline bool button_down(Input *in, s32 button) {
...
static inline bool button_pressed(Input *in, s32 button) {
    return (in->new_button_state & button) && !(in->old_button_state & button);
}
static inline bool button_pressed(Input in, s32 button) {

...
struct Game {
    ...
    struct {
        ...
        v2    xhair_offsets    [     MAX_PLAYER_COUNT]; // Immediate
    ...
    struct {
        ...
        v2  offsets           [    MAX_PARTNER_COUNT];
        s32 players           [    MAX_PARTNER_COUNT];
    } partners;
    
    struct {
        s32 count;
        v2  ps                 [MAX_LIVE_ENTITY_COUNT];
        f32 cooldowns          [MAX_LIVE_ENTITY_COUNT];
    } turrets;
